...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  List<Widget> _buldLandscapeContent(
      MediaQueryData mediaQuery, AppBar appBar, Widget transactionsList) {
    return [
      Container(
  ...
  Widget build(BuildContext context) {
    ...
    final pageBody = SafeArea(
      ...
      child: Column(
        children: <Widget>[
          if (isLandscape)
            ..._buldLandscapeContent(mediaQuery, appBar, transactionsList),
          if (!isLandscape)
            ..._buildPortraitContent(mediaQuery, appBar, transactionsList),
        ],
      ),
    ));
